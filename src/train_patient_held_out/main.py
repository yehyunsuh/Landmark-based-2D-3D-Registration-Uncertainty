...
if __name__ == "__main__":
    ...
    os.makedirs(f"{args.result_dir}/patient_held_out/{args.wandb_name}/visualization", exist_ok=True)
    os.makedirs(f"{args.result_dir}/patient_held_out/{args.wandb_name}/graph", exist_ok=True)
    os.makedirs(f"{args.model_weight_dir}/patient_held_out/", exist_ok=True)
    os.makedirs(f"{args.result_dir}/patient_held_out/{args.wandb_name}/train_results", exist_ok=True)
