    ...
    def __init__(self, data_dir, specimen_id='17-1882', image_resize=512, n_landmarks=14, dilation_iters=65, invisible_landmarks=True, data_type='train', task_type='easy', model_type='patient_specific', seed=42):
        ...
        with open(csv_path, 'r') as f:
            ...
            for row in reader:
                ...
                self.samples.append((self.specimen_id, image_name, landmarks))
...
def preprocessing(args):
    image_dir = f'{args.data_dir}/{args.specimen_id}/drr_projections_{args.task_type}'
    landmark_dir = f'{args.data_dir}/{args.specimen_id}/drr_projections_csv_{args.task_type}'
    ...
    for i, landmark_data_path in enumerate(landmark_data_path_list):
        ...
        image_path = f'{image_dir}/{args.specimen_id}_{image_name}'
        image = cv2.imread(image_path)
        ...
        row = [args.specimen_id, image_name, image_width, image_height, num_landmarks] + landmark_coords
        rows.append(row)
