...
class SegmentationDataset(Dataset):
    def __init__(self, data_dir, image_resize=512, n_landmarks=14, dilation_iters=65, invisible_landmarks=True, data_type='train', task_type='easy', model_type='patient_agnostic'):
