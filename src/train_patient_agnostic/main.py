...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_type", type=str, default="patient_agnostic", help="Type of model")
    ...
    parser.add_argument("--wandb_project", type=str, default="Landmark Detection Patient-Agnostic", help="Weights & Biases project name")
